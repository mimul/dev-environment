...
|---|---|---|---|---|---|---|
|FATAL|치명적인|【서비스 정지】 어플리케이션의 계속이 불가능한 에러. 서비스를 중지. 필수 환경 변수가 설정되지 않은 경우.|✅️|✅️|✅️|✅️|
|ERROR|오류|【요 대응】 특정의 요구 처리는 실패했지만, 어플리케이션 자체는 동작을 계속할 수 있는 에러. 처리중 예기치 않은 예외 등|✅️|✅️|✅️|✅️|
